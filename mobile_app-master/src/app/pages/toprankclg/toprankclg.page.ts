...
@Component({
  ...
  templateUrl: './toprankclg.page.html',
  styleUrls: ['./toprankclg.page.scss'],
})
export class ToprankclgPage implements OnInit {
  ...
  async gettoprnkclg() {
    ...
    this.service.gettoprankclg(this.id).subscribe(
      async (res) => {
